  ...
  return (
    <main className="h-[1000px] w-full flex flex-col justify-center items-center bg-[#f5f5dc]">
      <article className=" h-[200px] w-full flex flex-col items-center justify-evenly bg-[#f4b84e] text-white">
        <h1 className="text-6xl font-bold p-5">Service</h1>
      ...
      <section className=" h-[800px] w-full flex flex-col items-center justify-evenly">
        <Image
          ...
          className="w-1/3"
        />
        <div className="bg-contain bg-no-repeat bg-center bg-[url('/home.webp')] w-2/3 h-3/4 flex flex-col justify-evenly items-center pt-10">
          <p className="w-2/3 font-semibold text-2xl text-center leading-loose">
            {infoForLingo}
          </p>
          <span className="hover:text-blue-600 hover:underline hover:underline-offset-8"><a href="https://lingo-academy.org">Go to the site</a></span>
        </div>
      </section>
    </main>
  );
